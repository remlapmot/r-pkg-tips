...
- Binary - the 'compiled' version of the bundled package compressed (`.zip` on Windows)
  - `/R` no longer contains `.R` files, 3 files that store the parsed functions in an efficient file format - result of loading all the R code nd then saving the functions with `save()`
